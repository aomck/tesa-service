...
import { TokenService } from './object-detection/token.service';
...
@Module({
  ...
  providers: [ObjectDetectionService, ObjectDetectionGateway, ClearDataService, TokenService, FileService],
})
